...
export const ARTICLES: Article[] = [
  {
    ...
    body: [
      ...
      'Knowing which phase you are in explains a lot — and logging is how Selenya learns your version of it, not the textbook one.',
    ],
  },
  {
    ...
    body: [
      ...
      'That is why Selenya shows an uncertainty band around predictions and never pretends to day-perfect accuracy — anyone who does is guessing with confidence.',
  ...
  },
  {
    ...
    body: [
      ...
      'Log your cramps in Selenya: seeing that they arrive, say, the day before flow starts turns dread into a plan.',
  ...
  },
  {
    ...
    body: [
      ...
      'Selenya combines what you log: with test results and temperatures, the estimate anchors to your body instead of the calendar.',
  ...
  },
  {
    ...
    body: [
      ...
      'Log it in Selenya and the chart draws itself — look for the sustained shift, not any single reading. Alcohol, illness, and short sleep all nudge the numbers.',
    ],
  },
  {
    slug: 'peri-what-is',
    ...
    body: [
      ...
      "Selenya’s perimenopause mode scores how often transition-associated symptoms appear in your logs and watches cycle variability for you.",
  ...
  },
  {
    ...
    body: [
      ...
      'Selenya tracks your week and due date on-device. Prenatal care is irreplaceable — the app is a companion, not a substitute.',
    ],
  },
  {
    slug: 'why-local',
    ...
    body: [
      ...
      "Selenya’s default is architectural: your logs live in your phone’s app storage. Core tracking needs no account and no Selenya-hosted user database.",
