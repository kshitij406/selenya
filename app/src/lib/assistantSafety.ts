...
export function screenAssistantUrgency(message: string): AssistantSafetyIntercept | null {
  ...
  if (
    ...
    return {
      ...
      response:
        'Those symptoms can require urgent in-person care. Contact local emergency services or go to the nearest emergency department now, especially if symptoms are ongoing, worsening, or accompanied by faintness. Do not rely on Selenya to assess an emergency.',
    }
  }
